	...
	mapper(NULL)
{
	...
	depth2xyz = new CameraSpacePoint[cDepthWidth*cDepthHeight];    // Maps depth pixels to 3d coordinates
    ...
    if (SUCCEEDED(hrDepth))
    {
        ...
        if (SUCCEEDED(hr))
        {
			 ...
			 mapper->MapDepthFrameToCameraSpace(
				 cDepthWidth*cDepthHeight, pBuffer,        // Depth frame data and size of depth frame
				 cDepthWidth*cDepthHeight, depth2xyz); // Output CameraSpacePoint array and size
        }
